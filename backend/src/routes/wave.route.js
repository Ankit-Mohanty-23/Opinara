...
Router.get("/user-wave", auth, validate(getWavesSchema), getWaves);

// Search waves
// Example: /waves/search?q=wave-name
Router.get("/search", validate(SearchWaveSchema), SearchWave);

// Delete wave (SHOULD be DELETE, not GET)
Router.delete("/:waveId", auth, validate(deleteWaveSchema), deleteWave);

// Get members with filters
// Example:
// /waves/123/members?page=1&limit=20&role=moderator&status=active&search=ankit
Router.get("/:waveId/members", validate(getMembersSchema), getMembers);
